    ...
    return (
      ...
      >
        ...
        <View style={styles.meta}>
          <Text style={styles.metaText}>Người post: {post.author}</Text>
          <Text style={styles.metaText}>Nhận xét: {post.viewed}</Text>
          <Text style={styles.metaText}>Lượt xem: {post.viewed}</Text>
        </View>
